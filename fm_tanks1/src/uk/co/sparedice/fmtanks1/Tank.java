...
import uk.co.sparedice.fmtanks1.IWorld.TankTask;
...
public class Tank extends PhysicsActor {
    ...
    /* The maxiumum health of the tank */
    protected float maxHealth = 100;

    /* The current health level of the tank */
    ...
    public void act(float delta){
        ...
        int aha = (int) turretAngle;
        if(turretAngle % 3 == 0){
            container.addObject(new Bullet(container, team, turretAngle, posX, posY));
        }
